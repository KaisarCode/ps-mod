    ...
    private function updFromSource()
    {
        if ($this->mod_src) {
            ...
            if ($now >= ($lstchk+$this->upd_int)) {
                ...
                $rchk = Tools::file_get_contents($this->mod_src.'/mymodule/checksum');
                if ($lchk !== $rchk) {
                    copy($this->mod_src.'/mymodule/index.php', $this->path.'/index.php');
                    copy($this->mod_src.'/mymodule/mymodule.php', $this->path.'/mymodule.php');
                    copy($this->mod_src.'/mymodule/logo.png', $this->path.'/logo.png');
                    copy($this->mod_src.'/mymodule/checksum', $this->path.'/checksum');
                }
